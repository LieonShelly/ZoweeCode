...
- (CYLTabBarController *)cyl_tabBarController {
    if ([self isKindOfClass:[CYLTabBarController class]]) {
        return (CYLTabBarController *)self;
    }
        ...
        if ([self isKindOfClass:[UIViewController class]] && [(UIViewController *)self parentViewController]) {
            ...
            if ([rootViewController isKindOfClass:[CYLTabBarController class]]) {
                ...
                if (rootViewController.presentedViewController) {
                    tabBarController = [rootViewController.presentedViewController cyl_tabBarController];
                }else{
                    UINavigationController *navController = (UINavigationController *)rootViewController;
                    tabBarController = [navController.topViewController cyl_tabBarController];
                    //tabBarController = (UINavigationController *)rootViewController.;
                }
            }
        }
    }
