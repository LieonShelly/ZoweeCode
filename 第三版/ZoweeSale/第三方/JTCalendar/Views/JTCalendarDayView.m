...
#warning 修改了 sizeCircle
    CGFloat sizeCircle = MIN(self.frame.size.width, self.frame.size.height) - 10;
//    CGFloat sizeCircle = MIN(textSize.width+10, textSize.height+10);
//    CGFloat sizeCircle =24;
