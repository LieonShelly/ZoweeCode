...
- (void)setup{
    ...
    _moreInfo = [UIImageView new];
    [_bgView addSubview:_moreInfo];
    _moreInfo.image = [UIImage imageNamed: @"Button_arrow_double"];
    _moreInfo.sd_layout
    .topSpaceToView(_bgView,15)
...
- (void)layoutSubviews
{
    ...
    //报表
    CGFloat width = 170;
    CGFloat x = SCREEN_WIDTH - width - 50;
    ...
    dateLab.textColor = hexColorString(@"999999");
    dateLab.font = [UIFont systemFontOfSize:10];
    dateLab.text = _model.StrTime;
    dateLab.frame = CGRectMake(_barChart.frame.size.width - [dateLab labelSizeWidth]  , 0, [dateLab labelSizeWidth], 10);
    [_barChart addSubview:dateLab];
}
