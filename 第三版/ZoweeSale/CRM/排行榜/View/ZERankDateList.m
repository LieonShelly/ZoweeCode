...
@interface ZERankDateList ()<UITableViewDelegate,UITableViewDataSource>
{
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(_yearArray.count > 0 && _monthArray.count>0){ 
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:@"rankListDateChange" object:self userInfo:@{@"month":_monthArray[0],@"year":_yearArray[0]}];
        self.alpha = 0;
        //[_yearArray removeAllObjects];
        //[_monthArray removeAllObjects];
    }
