...
- (void)setFurniture:(ZEFurnitureModel *)furniture
{
    _furniture = furniture;
    self.doorTypeLable.text = furniture.furnitureName;
    self.doorSizeLable.text = furniture.furnitureSzie;
    self.doorImageView.image = [UIImage imageNamed: furniture.furnitureIcon];
}
#pragma mark - 与触控相关
