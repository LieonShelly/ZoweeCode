...
- (void)setupUI {
    ...
    _yearLeast = [NSCalendar currentYear];
    _yearSum   = 50;
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(nullable UIView *)view
{
    ...
    if (component == 0) {
        ...
        text =  [NSString stringWithFormat:@"%ld", row + [NSCalendar getFirstMonthWithYear:self.year]];
    }else{
        text = [NSString stringWithFormat:@"%ld", row + [NSCalendar getFirstDayWithYear:self.year Month:self.month]];
    }
